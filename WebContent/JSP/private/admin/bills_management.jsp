...
<body class="">
   ...
   <section class="container text-center col-12" style="margin-top: 100px">
   	<div class="row justify-content-center">
    	<div class="col-xl-7 col-lg-12">
    		<h2>Pedidos para ${user.useCompany.comName}</h2>
    		<br/>
    	...
    	<div class="col-xl-4 col-lg-10 col-10 invisible" style="position: relative; top: 95px;" id="bill-details">
